...
\begin{remark}\label{rem:gfMatrix}
	Let $g \in \Bn{n}$ and $\hat{a} = (a_I)_{I \subseteq [1,n] }$ be the vector of the coefficients of the $ANF$ of $g$, as a consequence of the construction of $G_{r,n}^{f,S}$, we have that
	\begin{equation}
	\begin{aligned}
	...
	Therefore, solving $ \hat{a} G_{r,n}^f = 0$ is equivalent to solving $f*g = 0$, or in other words, finding the kernel of $G_{r,n}^f$ is equivalent to finding all annihilators of $f$ of degree up to $r$.
\end{remark}
